...
contract UpgradeDelegator is Governed {
   ...
   */
  function changeProxyAdmin(AdminUpgradeabilityProxy proxy, address newAdmin) public virtual  onlyAuthorizedChanger {
   ...
   */
  function upgrade(AdminUpgradeabilityProxy proxy, address implementation) public virtual onlyAuthorizedChanger {
   ...
   */
  function upgradeAndCall(AdminUpgradeabilityProxy proxy, address implementation, bytes memory data) public payable virtual onlyAuthorizedChanger {
